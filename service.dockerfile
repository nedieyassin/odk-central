...
RUN echo "${central_version}" > /tmp/sentry-versions/central
WORKDIR /server
RUN echo "${central_version}" > /tmp/sentry-versions/server
WORKDIR /client
RUN echo "${central_version}" > /tmp/sentry-versions/client
